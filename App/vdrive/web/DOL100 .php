...
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=INDEXBOM:DOL100 ');
$avgp = "1791.31"; 
$high = "1821.96";
$low = "1786.67";
 $json = str_replace("\n", "", $quote);
...
$temp = file_get_contents("DOL100 TEMP.txt", "r");
...
$risk = ($json_output['l'] - $low) * (200000/$json_output['l']);
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "DOL100 :". "breaking:PHIGH:"."Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "DOL100 :". "retracing:PHIGH:"."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "DOL100 :". "breaking:PLOW:"."short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "DOL100 :". "retracing:PLOW:"."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "DOL100 :". "sliding up:PAVG:"."Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "DOL100 :". "Sliding down:PAVG:"."Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("DOL100 TEMP.txt", "w");
