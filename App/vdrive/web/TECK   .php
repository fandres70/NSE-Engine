...
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=INDEXBOM:BSE-TECK   ');
$avgp = "3336.16"; 
$high = "3384.37";
$low = "3324.88";
 $json = str_replace("\n", "", $quote);
...
$temp = file_get_contents("BSE-TECK   TEMP.txt", "r");
...
$risk = ($json_output['l'] - $low) * (200000/$json_output['l']);
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "BSE-TECK   :". "breaking:PHIGH:"."Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "BSE-TECK   :". "retracing:PHIGH:"."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "BSE-TECK   :". "breaking:PLOW:"."short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-TECK   :". "retracing:PLOW:"."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-TECK   :". "sliding up:PAVG:"."Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "BSE-TECK   :". "Sliding down:PAVG:"."Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("BSE-TECK   TEMP.txt", "w");
