<?php
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=INDEXBOM:BSE-CD  ');
$avgp = "6610.41"; 
$high = "6748.96";
$low = "6541.05";
 $json = str_replace("\n", "", $quote);
...
$temp = file_get_contents("BSE-CD  TEMP.txt", "r");
...
$risk = ($json_output['l'] - $low) * (200000/$json_output['l']);
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "BSE-CD  :". "breaking:PHIGH:"."Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "BSE-CD  :". "retracing:PHIGH:"."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "BSE-CD  :". "breaking:PLOW:"."short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-CD  :". "retracing:PLOW:"."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-CD  :". "sliding up:PAVG:"."Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "BSE-CD  :". "Sliding down:PAVG:"."Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("BSE-CD  TEMP.txt", "w");
