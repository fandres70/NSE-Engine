...
$time = date('h:i:s',$new_time);
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "CVX:". "breaking_P_HIGH_at". $high. "_by_". $time. "\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "CVX:". "retracing_P_HIGH_at". $high."_by_". $time. "\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "CVX:". "breaking_P_LOW_at". $json_output['l']. "_by_". $time. "\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "CVX:". "retracing_P_LOW_at". $json_output['l']. "_by_". $time. "\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "CVX:". "sliding_above_P_AVG_at". $json_output['l']. "_by_". $time. "\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "CVX:". "Sliding_below_P_AVG_at". $json_output['l']. "_by_". $time. "\r\n");
	fclose( $filedash );	 
     }   
}
