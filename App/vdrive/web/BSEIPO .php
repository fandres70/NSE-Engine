...
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=INDEXBOM:BSE-IPO ');
$avgp = "1478.62"; 
$high = "1505.38";
$low = "1477.17";
 $json = str_replace("\n", "", $quote);
...
$temp = file_get_contents("BSE-IPO TEMP.txt", "r");
...
$risk = ($json_output['l'] - $low) * (200000/$json_output['l']);
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "BSE-IPO :". "breaking:PHIGH:"."Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "BSE-IPO :". "retracing:PHIGH:"."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "BSE-IPO :". "breaking:PLOW:"."short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-IPO :". "retracing:PLOW:"."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "BSE-IPO :". "sliding up:PAVG:"."Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "BSE-IPO :". "Sliding down:PAVG:"."Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("BSE-IPO TEMP.txt", "w");
